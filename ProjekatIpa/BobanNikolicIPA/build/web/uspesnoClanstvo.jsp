<%-- 
    Document   : uspesnoClanstvo
    Created on : Jun 26, 2020, 10:00:32 AM
    Author     : Boban
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">  
            <div id="naslov">
                <h1>Uspesno ste se uclanili!</h1>
                <p>Na blagajni mozete potvrditi clanstvo i preuzeti clansku karticu.</p>
            </div>                              
            <div id="content">  
