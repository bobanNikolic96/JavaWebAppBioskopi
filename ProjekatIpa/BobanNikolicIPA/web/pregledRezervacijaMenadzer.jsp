<%-- 
    Document   : pregledRezervacijaMenadzer
    Created on : Jun 27, 2020, 7:40:42 PM
    Author     : Boban
--%>

<%@page import="beans.RezervacijaBean"%>
...
<html>
    ...
    <body >   
        ...
        <div class="container">  
            ...
            <div id="content">  
             <%
                 ArrayList<RezervacijaBean> rezervacije = (ArrayList<RezervacijaBean>)request.getAttribute("rezervacije");
             %>
            <table>              
                <th>Username</th>
                <th>Ime i prezime</th>
                ...
                <th>ID projekcije</th> 
                <th>ID Korisnika</th>
                <% for(RezervacijaBean r : rezervacije){
                %> 
                <tr>
                    <td><%=r.getUsername()%></td>
