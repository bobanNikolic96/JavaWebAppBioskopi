<%-- 
    Document   : menadzerStranica
    Created on : Jun 27, 2020, 7:13:22 PM
    Author     : Boban
--%>
...
<html>
    ...
    <body >   
        ...
        <div class="container" >   
            <div id="naslov">
                <h1>Menadzer stranica</h1>
            </div>            
            <h4>Pregled aktivnih rezervacija karata: 
                <a href="AktivneRezervacijeMenadzerServlet">Podaci o rezervacijama</a>&nbsp&nbsp
            </h4>
            <br><br>
            <h4>Pregled clanova klubova: 
                <a href="PrikazClanovaKlubovaMenadzerServlet">Podaci o clanovima klubova</a>&nbsp&nbsp
            </h4>
        </div>
            <br>                     
        </div>
