<%-- 
    Document   : izmeniBioskopAdmin
    Created on : Jun 27, 2020, 1:29:38 PM
    Author     : Boban
--%>
...
<html>
    ...
    <body >   
        ...
        <div class="container" >   
            ...
            %>
           <form method="post" action="PotvrdiIzmeneBioskopServlet">
                            <label for="naziv">Naziv:</label>
                            <input type="text" name="naziv" value="<%=b.getNaziv()%>"> <br><br>

                            <label for="grad">Grad:</label>
                            <input type="text" name="grad" value="<%=b.getGrad()%>"> <br><br>

                            <label for="slika">Slika:</label>
                            <input type="file" id="img" name="slika" accept="image/*" value="<%=b.getSlika()%>"> <br><br>

                            <label for="tehnologije">Tehnologije:</label>
                            <input type="text" name="tehnologije" value="<%=b.getTehnologije()%>"> <br><br> 

                            <label for="radnoVreme">Radno vreme:</label>
                            <input type="text" name="radnoVreme" value="<%=b.getRadnoVreme()%>"> <br><br> 

                            <label for="kontakt">Kontakt:</label>
                            <input type="text" name="kontakt" value="<%=b.getKontakt()%>"> <br><br> 
                            
                              <input type="hidden" name="id" value="<%=b.getiDbioskop()%>">
