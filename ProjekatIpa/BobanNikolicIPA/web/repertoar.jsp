<%-- 
    Document   : repertoar
    Created on : Jun 5, 2020, 2:35:49 PM
    Author     : Boban
--%>
    ...
    <head>
       ...
       <body >   
        ...
        <div class="container" >   
            <div id="naslov">
                <h1>Repertoar</h1>
                <p>Spisak trenutnih projekcija</p>
            </div>
            <% 
            ...
            <table>
                ...
                <tr> 
                    ...
                    <td><%=t.getCena()%></td>
                    <td><a href="PrikazSedista?idSale=<%=t.getIdSala()%>&idTermina=<%=t.getId()%>"><input type="button" value="Rezervisi kartu"></a></td>
                </tr>
                <% } %>
            </table>    
            </div>              
