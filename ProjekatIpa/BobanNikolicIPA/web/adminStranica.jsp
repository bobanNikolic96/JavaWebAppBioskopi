<%-- 
    ...
    Created on : Jun 27, 2020, 9:52:41 AM
    Author     : Boban
--%>
...
<html>
    ...
    <body >   
        ...
        <div class="container" >   
            ...
            <h4>Administriranje korisnika: 
                <a href="AdministriranjeKorisnikaServlet">Izmeni/obrisi podatke korisnika</a>&nbsp&nbsp
            </h4>
            <br><br>
            <h4>Administriranje bioskopa: 
                <a href="dodajBioskopAdmin.jsp">Dodaj bioskop</a>&nbsp&nbsp
                <a href="AdministriranjeBioskopaServlet">Izmeni/obrisi podatke o bioskopu</a>&nbsp&nbsp
            </h4>
            <br><br>
            <h4>Administriranje projekcija: 
                <a href="dodajProjekcijuAdmin.jsp">Dodaj projekciju</a>&nbsp&nbsp
                <a href="AdministriranjeProjekcijaAdmin">Izmeni/obrisi podatke o projekciji</a>&nbsp&nbsp
            </h4>
            <br><br>
        </div>
            <br>                     
