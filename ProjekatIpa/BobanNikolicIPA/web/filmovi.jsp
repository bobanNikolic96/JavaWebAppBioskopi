    ...
    <body>   
        ...
        <div class="container">  
            <div id="naslovFilmovi">
                <h1>Filmovi</h1>
                <p>Aktuelni filmovi u nasim bioskopima</p>
            </div>                              
            <div class="content">               
                ...
                %>
                <div class="film">
                    <a class="slika" href="PrikazFilmaServlet?naziv=<%=f.getNaziv()%>"> <img src="<%=f.getSlika()%>" width="200" height="250"> </a>
                    <div class="ime"><a href="PrikazFilmaServlet?naziv=<%=f.getNaziv()%>"> <%= f.getNaziv() %> </a> </div>
                </div>
                <% } %>
